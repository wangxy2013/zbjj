...
/**
 * 作者：王先云 on 2018/6/20 15:01
 * 邮箱：wangxianyun1@163.com
 * 描述：一句话简单描述
 */
public class LiveVideoPlayer  extends GSYVideoPlayer {
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, LiveVideoPlayer.this);
        }
        prepareVideo();
