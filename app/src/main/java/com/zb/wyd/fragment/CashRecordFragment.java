...
public class CashRecordFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener<RecyclerView>, IRequestListener
{
    ...
    private void getWealthList()
    {
        ...
        DataRequest.instance().request(getActivity(), Urls.getFortuneOrderDetailUrl(), this, HttpRequest.GET, GET_WEALTH_LIST, valuePairs, new WealthInfoListHandler());
    }
