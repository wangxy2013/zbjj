 ...
 * 描述：搜索主播列表
 */
public class AnchorSearchFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener<RecyclerView>, IRequestListener, View.OnClickListener
{
    ...
    protected void initViewData()
    {
        ...
        ( (SearchActivity)getActivity()).setAnchorSearchListener(new SearchListener() {
            @Override
            public void setKeyword(String keyword)
            {
                AnchorSearchFragment.this.keyword = keyword;
                liveInfoList.clear();
                pn = 1;
                mRefreshStatus = 0;
                loadData();
    ...
    private void loadData()
    {
        ...
        DataRequest.instance().request(getContext(), Urls.getSearchUrl(), this, HttpRequest.GET, GET_COLLECTION_VIDEO_LIST, valuePairs,
