...
{
    private boolean IS_SCREEN_ORIENTATION_LANDSCAPE;
    //亮度dialog
    ...
    public void setIS_SCREEN_ORIENTATION_LANDSCAPE(boolean IS_SCREEN_ORIENTATION_LANDSCAPE)
    {
        this.IS_SCREEN_ORIENTATION_LANDSCAPE = IS_SCREEN_ORIENTATION_LANDSCAPE;
    }
    ...
    {
        if(!IS_SCREEN_ORIENTATION_LANDSCAPE)
        {
